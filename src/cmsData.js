    ...
    blocks: [
      ...
      },
      {
        ...
        content: {
          ...
          ratingText: "1000+ тортов за 6 лет",
        },
      },
      {
        id: "services",
      ...
      },
      {
        ...
        type: "trust",
          ...
          text:
            "6 лет опыта, финалист шоу «Кондитер» с Ренатом Агзамовым, 1000+ тортов, 320 постоянных клиентов и 8+ ивент-агентств в сотрудничестве.",
          stats: [
